...
import cool.scx.example.auth.exception.MaximumAtLoginInSameTimeException;
...
public final class ScxAuth {
     ...
     */
    private static final String SCX_EXAMPLE_SESSION_PATH = "AppRoot:scx-example-session.bin";
    ...
    public static void initAuth() {
        ...
        ScxContext.scxMappingConfiguration().setScxMappingInterceptor(new ScxAuthInterceptor());
        //设置请求头
        ...
        //设置 cookie handler
        ScxCookieHandlerConfiguration.setScxCookieHandler(new ScxAuthCookieHandler());
        // 初始化 service
    ...
    public static void readSessionFromFile() {
        var sessionCache = ScxContext.getFileByAppRoot(SCX_EXAMPLE_SESSION_PATH);
    ...
    private static void initWhenTheNumberOfLoginsInSameTimeReachesTheMaximum() {
        var s = ScxContext.config().get("example.when-the-number-of-logins-in-same-time-reaches-the-maximum", String.class);
    ...
    private static final class ScxAuthCookieHandler implements Handler<RoutingContext> {
